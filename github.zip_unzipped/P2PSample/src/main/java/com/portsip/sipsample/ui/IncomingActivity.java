...
public class IncomingActivity extends Activity implements PortMessageReceiver.BroadcastListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sessionId = intent.getLongExtra("incomingSession", PortSipErrorcode.INVALID_SESSION_ID);
        ...
        if(application.mEngine!=null){
            ...
            switch (view.getId()){
                ...
                case R.id.answer_video:
                    ...
                    application.mEngine.answerCall(sessionId,view.getId()==R.id.answer_video);
